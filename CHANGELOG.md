...
- add opt-in `depth_aware_diagrammatic` hidden-line visibility and
  `depth_aware_teaching_transparent` surface layering to static TikZ Dandelin
  spatial views by reusing the analytic quadric boundary, cone-sheet, and
