...
contact circles, the conic, the cutting-plane outline, and directrices into
solid visible fragments and dashed hidden fragments for the authored parallel
view, then order them with the shared fragment painter graph. Translucent surface
