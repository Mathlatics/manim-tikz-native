    ...
    *,
    ...
    return {
        ...
        "capabilities": {
            ...
            "face_depth_cue_parallel_v1": True,
            "convex_line_solid_intersection_v1": True,
            "convex_polyhedron_section_parallel_v1": True,
            "convex_section_transparent_compositing_parallel_v1": True,
            "copy_identity_handoff_v1": True,
            "derived_dihedral_visibility_parallel_v1": True,
            "derived_dihedral_transparent_compositing_parallel_v1": True,
            "derived_dihedral_unified_compositing_parallel_v1": True,
            "derived_dihedral_base_plane_rotation_v1": True,
