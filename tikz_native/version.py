...
_NATIVE_SOURCE_3D_V3_REVISION: Final = (
...
_DECLARED_COMPONENT_REVISIONS: Final[dict[str, str]] = {
    ...
    COMPONENT_NATIVE_MANIM_SOURCE_3D_V3: _NATIVE_SOURCE_3D_V3_REVISION,
...
_DECLARED_IMPLEMENTATION_DIGESTS: Final[dict[str, str]] = {
    ...
    COMPONENT_NATIVE_MANIM_SOURCE_3D_V3: (
        "edd2fb995d5f551754260f7906e15547393302bc757925b174c6007b05b544a6"
    ),
    COMPONENT_EMBEDDED_MOTION_3D: (
    ...
    COMPONENT_TIKZ_OPEN_FACE_VISIBILITY_3D: (
        "e9b8d7f72a8e18852d3c104a10cf513f2dc7bb968267a7952325eb1dc065e495"
    ),
    COMPONENT_TIKZ_OPEN_FACE_STATIC_ASSET_3D: (
        "056d7ce589b9f2ef2679e2e847c58f875eea72fecc2f88e5f598fd4c79993c8f"
    ),
}
